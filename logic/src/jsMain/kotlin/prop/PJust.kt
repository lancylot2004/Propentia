...
sealed class PJust {
    ...
    data class OrE(val orig: ID, val resL: ID, val resR: ID) : PJust() {
        override val tag = "∨E"
    ...
    data class ImpI(val ant: ID, val csq: ID) : PJust() {
        override val tag = "->I"
    ...
    data class ImpE(val imp: ID, val ant: ID) : PJust() {
        override val tag = "->E"
    ...
    data class NotI(val phi: ID, val bot: ID) : PJust() {
        override val tag = "¬I"
    ...
    data class IffE(val iff: ID, val phi: ID) : PJust() {
        override val tag = "<->E"
    ...
    data class IffED(val orig: ID) : PJust() {
    ...
    data class MT(val imp: ID, val notCsq: ID) : PJust() {
    ...
    data class PC(val phi: ID, val bot: ID) : PJust() {
